...
class AppAdapter(
    ...
    private var appLabelColor: Int = 0
    private var iconSocketBackgroundState: Drawable.ConstantState? = null
    ...
    inner class AppViewHolder(val binding: ItemAppBinding) :
        ...
        private fun applyCurrentTheme() {
            binding.appName.setTextColor(appLabelColor)
            binding.iconSocket.background = iconSocketBackgroundState
                ?.newDrawable()
                ?.mutate()
        }
    ...
    fun updateThemeResources(labelColor: Int, socketBackground: Drawable?) {
        appLabelColor = labelColor
        iconSocketBackgroundState = socketBackground?.constantState
    }
