 ...
 * Handles fallback to system icons and caches results via IconCache.
 */
class IconProvider(
    ...
    /** Retrieves the default system icon for a package, with a ultimate fallback. */
