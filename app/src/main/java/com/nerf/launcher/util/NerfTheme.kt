...
data class NerfTheme(
    ...
    val hudAppLabelColor: Int,
    val drawerBorderColor: Int,
    val scanlineGlowColor: Int,
    val hudEnergyHighColor: Int,
    val hudEnergyLowColor: Int,
    val reactorMidAColor: Int,
    val reactorMidBColor: Int,
    val reactorAccentRingColor: Int,
    val reactorCoreGlowColor: Int,
