...
object ThemeRepository {
    ...
    private val classicNerf = ThemeSpec(
        ...
        windowBackgroundRes = R.color.theme_classic_window_background,
        taskbarDarkBackgroundRes = R.color.theme_classic_taskbar_dark_background,
        taskbarLightBackgroundRes = R.color.theme_classic_taskbar_light_background,
        ...
        hudInfoRes = R.color.theme_classic_hud_cyan,
        hudWarningRes = R.color.theme_classic_hud_orange,
        hudSuccessRes = R.color.theme_shared_hud_lime,
        hudAccentRes = R.color.theme_classic_hud_magenta,
        hudAppLabelRes = R.color.theme_shared_hud_app_label,
        drawerBorderRes = R.color.theme_classic_drawer_border,
        scanlineGlowRes = R.color.theme_classic_scanline_glow,
        hudEnergyHighRes = R.color.theme_classic_hud_energy_high,
        hudEnergyLowRes = R.color.theme_classic_hud_energy_low,
        reactorMidARes = R.color.theme_classic_reactor_mid_a,
        reactorMidBRes = R.color.theme_classic_reactor_mid_b,
        reactorAccentRingRes = R.color.theme_classic_reactor_accent_ring,
        reactorCoreGlowRes = R.color.theme_classic_reactor_core_glow,
        ...
        assistantMutedRes = R.color.theme_classic_assistant_muted,
    ...
    private val stealthOps = ThemeSpec(
        ...
        windowBackgroundRes = R.color.theme_stealth_window_background,
        taskbarDarkBackgroundRes = R.color.theme_stealth_taskbar_dark_background,
        taskbarLightBackgroundRes = R.color.theme_stealth_taskbar_light_background,
        lockSurfaceScrimRes = R.color.theme_shared_lock_surface_scrim,
        hudInactiveMeterRes = R.color.theme_shared_hud_inactive_meter,
        hudPanelTextPrimaryRes = R.color.theme_shared_hud_panel_text_primary,
        hudPanelTextSecondaryRes = R.color.theme_shared_hud_panel_text_secondary,
        hudInfoRes = R.color.theme_stealth_hud_cyan,
        hudWarningRes = R.color.theme_stealth_hud_orange,
        hudSuccessRes = R.color.theme_shared_hud_lime,
        hudAccentRes = R.color.theme_stealth_hud_magenta,
        hudAppLabelRes = R.color.theme_shared_hud_app_label,
        drawerBorderRes = R.color.theme_stealth_drawer_border,
        scanlineGlowRes = R.color.theme_stealth_scanline_glow,
        hudEnergyHighRes = R.color.theme_stealth_hud_energy_high,
        hudEnergyLowRes = R.color.theme_stealth_hud_energy_low,
        reactorMidARes = R.color.theme_stealth_reactor_mid_a,
        reactorMidBRes = R.color.theme_stealth_reactor_mid_b,
        reactorAccentRingRes = R.color.theme_stealth_reactor_accent_ring,
        reactorCoreGlowRes = R.color.theme_stealth_reactor_core_glow,
        reactorArmorDarkRes = R.color.theme_shared_reactor_armor_dark,
        reactorArmorMidRes = R.color.theme_shared_reactor_armor_mid,
        reactorInteriorDarkRes = R.color.theme_shared_reactor_interior_dark,
        reactorInteriorMidRes = R.color.theme_shared_reactor_interior_mid,
        reactorFrameShadowRes = R.color.theme_shared_reactor_frame_shadow,
        assistantMutedRes = R.color.theme_stealth_assistant_muted,
        assistantErrorRes = R.color.theme_shared_assistant_error
    )
    ...
    private val eliteBlue = ThemeSpec(
        ...
        windowBackgroundRes = R.color.theme_elite_window_background,
        taskbarDarkBackgroundRes = R.color.theme_elite_taskbar_dark_background,
        taskbarLightBackgroundRes = R.color.theme_elite_taskbar_light_background,
        lockSurfaceScrimRes = R.color.theme_shared_lock_surface_scrim,
        hudInactiveMeterRes = R.color.theme_shared_hud_inactive_meter,
        hudPanelTextPrimaryRes = R.color.theme_shared_hud_panel_text_primary,
        hudPanelTextSecondaryRes = R.color.theme_shared_hud_panel_text_secondary,
        hudInfoRes = R.color.theme_elite_hud_cyan,
        hudWarningRes = R.color.theme_elite_hud_orange,
        hudSuccessRes = R.color.theme_shared_hud_lime,
        hudAccentRes = R.color.theme_elite_hud_magenta,
        hudAppLabelRes = R.color.theme_shared_hud_app_label,
        drawerBorderRes = R.color.theme_elite_drawer_border,
        scanlineGlowRes = R.color.theme_elite_scanline_glow,
        hudEnergyHighRes = R.color.theme_elite_hud_energy_high,
        hudEnergyLowRes = R.color.theme_elite_hud_energy_low,
        reactorMidARes = R.color.theme_elite_reactor_mid_a,
        reactorMidBRes = R.color.theme_elite_reactor_mid_b,
        reactorAccentRingRes = R.color.theme_elite_reactor_accent_ring,
        reactorCoreGlowRes = R.color.theme_elite_reactor_core_glow,
        reactorArmorDarkRes = R.color.theme_shared_reactor_armor_dark,
        reactorArmorMidRes = R.color.theme_shared_reactor_armor_mid,
        reactorInteriorDarkRes = R.color.theme_shared_reactor_interior_dark,
        reactorInteriorMidRes = R.color.theme_shared_reactor_interior_mid,
        reactorFrameShadowRes = R.color.theme_shared_reactor_frame_shadow,
        assistantMutedRes = R.color.theme_elite_assistant_muted,
        assistantErrorRes = R.color.theme_shared_assistant_error
    )
    ...
    private val zombieStrike = ThemeSpec(
        ...
        windowBackgroundRes = R.color.theme_zombie_window_background,
        taskbarDarkBackgroundRes = R.color.theme_zombie_taskbar_dark_background,
        taskbarLightBackgroundRes = R.color.theme_zombie_taskbar_light_background,
        lockSurfaceScrimRes = R.color.theme_shared_lock_surface_scrim,
        hudInactiveMeterRes = R.color.theme_shared_hud_inactive_meter,
        hudPanelTextPrimaryRes = R.color.theme_shared_hud_panel_text_primary,
        hudPanelTextSecondaryRes = R.color.theme_shared_hud_panel_text_secondary,
        hudInfoRes = R.color.theme_zombie_hud_cyan,
        hudWarningRes = R.color.theme_zombie_hud_orange,
        hudSuccessRes = R.color.theme_shared_hud_lime,
        hudAccentRes = R.color.theme_zombie_hud_magenta,
        hudAppLabelRes = R.color.theme_shared_hud_app_label,
        drawerBorderRes = R.color.theme_zombie_drawer_border,
        scanlineGlowRes = R.color.theme_zombie_scanline_glow,
        hudEnergyHighRes = R.color.theme_zombie_hud_energy_high,
        hudEnergyLowRes = R.color.theme_zombie_hud_energy_low,
        reactorMidARes = R.color.theme_zombie_reactor_mid_a,
        reactorMidBRes = R.color.theme_zombie_reactor_mid_b,
        reactorAccentRingRes = R.color.theme_zombie_reactor_accent_ring,
        reactorCoreGlowRes = R.color.theme_zombie_reactor_core_glow,
        reactorArmorDarkRes = R.color.theme_shared_reactor_armor_dark,
        reactorArmorMidRes = R.color.theme_shared_reactor_armor_mid,
        reactorInteriorDarkRes = R.color.theme_shared_reactor_interior_dark,
        reactorInteriorMidRes = R.color.theme_shared_reactor_interior_mid,
        reactorFrameShadowRes = R.color.theme_shared_reactor_frame_shadow,
        assistantMutedRes = R.color.theme_zombie_assistant_muted,
        assistantErrorRes = R.color.theme_shared_assistant_error
    )
    ...
    private val hyperNeon = ThemeSpec(
        ...
        windowBackgroundRes = R.color.theme_hyper_window_background,
        taskbarDarkBackgroundRes = R.color.theme_hyper_taskbar_dark_background,
        taskbarLightBackgroundRes = R.color.theme_hyper_taskbar_light_background,
        lockSurfaceScrimRes = R.color.theme_shared_lock_surface_scrim,
        hudInactiveMeterRes = R.color.theme_shared_hud_inactive_meter,
        hudPanelTextPrimaryRes = R.color.theme_shared_hud_panel_text_primary,
        hudPanelTextSecondaryRes = R.color.theme_shared_hud_panel_text_secondary,
        hudInfoRes = R.color.theme_hyper_hud_cyan,
        hudWarningRes = R.color.theme_hyper_hud_orange,
        hudSuccessRes = R.color.theme_shared_hud_lime,
        hudAccentRes = R.color.theme_hyper_hud_magenta,
        hudAppLabelRes = R.color.theme_shared_hud_app_label,
        drawerBorderRes = R.color.theme_hyper_drawer_border,
        scanlineGlowRes = R.color.theme_hyper_scanline_glow,
        hudEnergyHighRes = R.color.theme_hyper_hud_energy_high,
        hudEnergyLowRes = R.color.theme_hyper_hud_energy_low,
        reactorMidARes = R.color.theme_hyper_reactor_mid_a,
        reactorMidBRes = R.color.theme_hyper_reactor_mid_b,
        reactorAccentRingRes = R.color.theme_hyper_reactor_accent_ring,
        reactorCoreGlowRes = R.color.theme_hyper_reactor_core_glow,
        reactorArmorDarkRes = R.color.theme_shared_reactor_armor_dark,
        reactorArmorMidRes = R.color.theme_shared_reactor_armor_mid,
        reactorInteriorDarkRes = R.color.theme_shared_reactor_interior_dark,
        reactorInteriorMidRes = R.color.theme_shared_reactor_interior_mid,
        reactorFrameShadowRes = R.color.theme_shared_reactor_frame_shadow,
        assistantMutedRes = R.color.theme_hyper_assistant_muted,
        assistantErrorRes = R.color.theme_shared_assistant_error
    )
